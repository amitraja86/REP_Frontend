          ...
          <table>
            <tbody>
              ...
              <tr>
                ...
                <td>{candidate.serving_notice_period ? "Yes" : "No"}</td>
              </tr>
              <tr>
              ...
              <tr>
                <td>Aman Feedback</td>
                <td>{candidate.Aman_Feedback}</td>
              </tr>
              <tr>
                <td>Dhawal Feedback</td>
                <td>{candidate.Dhawal_Feedback}</td>
              </tr>
              <tr>
                <td>Nimit Feedback</td>
                <td>{candidate.Nimit_Feedback}</td>
              </tr>
              <tr>
                <td>Second Round Video Link</td>
                <td>{candidate.Second_Round_Video_Link}</td>
              </tr>
            </tbody>
          </table>
        </div>
